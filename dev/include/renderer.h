...
void renderer_sprite_update(u32 sprite_index, f64 delta_time, b8 pingpong);
void renderer_sprite_free(u32 sprite_index);
void renderer_sprite(u32 sprite_index, struct v2f position, struct v2f size, struct v2b flip, b8 rot90);
void renderer_text(struct v2f position, const i8 *format, ...);
void renderer_update(b8 in_menu);
